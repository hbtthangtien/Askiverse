    ...
    <body style=""margin: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 40px;"">
        <div style=""max-width: 600px; margin: auto; background-color: #fff; border-radius: 10px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"">
            ...
            <p style=""font-size: 15px; color: #555;"">
                Cảm ơn bạn đã đăng ký tài khoản tại <strong>Askiverse</strong>! Vui lòng nhấn nút bên dưới để xác nhận địa chỉ email của bạn:
            </p>
            ...
            <p style=""font-size: 12px; color: #aaa; text-align: center;"">© {DateTime.Now.Year} Askiverse. All rights reserved.</p>
        </div>
    </body>
    </html>";
			return body;
